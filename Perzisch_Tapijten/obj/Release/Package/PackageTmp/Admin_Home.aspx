<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Admin_Home.aspx.cs" Inherits="Perzisch_Tapijten.Admin_Home" %>
...
<%
    ...
    Perzisch_Tapijten.sql_object Sql_Obj = new Perzisch_Tapijten.sql_object();
    List<Perzisch_Tapijten.DetailObject> DetailRecord = Sql_Obj.GetDetail(sub);
    string Desc1 = null;
    string Desc2 = null;
    string edit = null;
    string delete = null;
    string imagelocation = null;
    foreach (Perzisch_Tapijten.DetailObject item in DetailRecord)
    {
