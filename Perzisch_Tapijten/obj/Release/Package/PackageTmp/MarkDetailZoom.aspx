<%@ Page Title="" Language="C#" MasterPageFile="~/Mark_Int.Master" AutoEventWireup="true" CodeBehind="MarkDetailZoom.aspx.cs" Inherits="Perzisch_Tapijten.MarkDetailZoom" %>
...
<%
    ...
    Perzisch_Tapijten.DetailObject DetailObj = SqlObj.GetDetail(id);
