<%@ Page Title="Perzisch Tapijten" Language="C#" MasterPageFile="~/Mark_Int.Master" AutoEventWireup="true" CodeBehind="Mark_Detail.aspx.cs" Inherits="Perzisch_Tapijten.Mark_Detail" %>
    ...
    <div>
        <div class="div_color">
            <%
                ...
                List<Perzisch_Tapijten.DetailObject> DetailObj = SqlObj.GetDetail(subid);
